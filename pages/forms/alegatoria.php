  ...
  <?php
    ...
    $fanombredemandante = "fanombredemandante";
    $fafechainicio = "2017-09-19";
    $fanombredemandado = "fanombredemandado";
    $fadireccion = "Direccion 2";
    $fafecha = "2017-08-19";
                              ...
                              <form id="form_validation" method="POST" action="alegatoria2.php">
                                  <fieldset>
                                      <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                          <div class="form-line">
                                              <input type="text" class="form-control" name="fafechainicio" value="<?php echo $fafechainicio ?>" disabled>
                                      ...
                                      <div class="col-sm-6">
                                        ...
                                        <div class=form-group>
                                          <div class="form-line">
                                              <input type="text" class="form-control" name="fanombredemandado" value="<?php echo $fanombredemandado ?>" disabled>
                                              <label class="form-label">Nombre del Cónyuge</label>
                                          </div>
                                        </div>
                                        <div class="form-group">
                                          <div class="form-line">
                                              <input type="text" class="form-control" name="fadireccion" value="<?php echo $fadireccion ?>" disabled>
                                      ...
                                      <div class="col-sm-4">
                                        <div class=form-group>
                                          <div class="form-line">
                                              <input type="text" class="form-control" name="fafecha" value=<?php echo $fafecha ?> disabled>
                                              <label class="form-label">Fecha</label>
                                          </div>
                                        </div>
                                        <div class="form-group">
                                          <div class="form-line">
                                              <input type="text" class="form-control" name="faarquidiocesis" value="<?php echo $faarquidiocesis ?>" disabled>
                                      ...
                                      <div class="col-sm-8">
                                        <div class=form-group>
                                          <div class="form-line">
                                              <input type="text" class="form-control" name="faciudadydepartamento" value="<?php echo $faciudadydepartamento ?>" disabled>
                                              <label class="form-label">Ciudad y Departamento</label>
                                          </div>
                                        </div>
                                        <div class="form-group">
                                          <div class="form-line">
                                              <input type="text" class="form-control" name="fanombreparroquia" value="<?php echo $fanombreparroquia ?>" disabled>
                                      ...
                                      <div class="col-sm-6">
                                        <div class="form-group">
                                          <div class="form-line">
                                                <input type="text" class="form-control" name="faduracionconvivencia" value="<?php echo $faduracionconvivencia ?>" disabled>
                                      ...
                                      <div class="col-sm-3">
                                        <div class="form-group">
                                          <div class="form-line">
                                              <input type="text" class="form-control" name="faconcubinatoprevio" value="<?php echo $faconcubinatoprevio ?>" disabled>
                                      ...
                                      <div class="col-sm-3">
                                        <div class="form-group">
                                          <div class="form-line">
                                              <input type="text" class="form-control" name="faconcubinatioduracion" value="<?php echo $faconcubinatioduracion ?>" disabled>
                                      ...
                                      <div class="col-sm-6">
                                        <div class="form-group">
                                          <div class="form-line">
                                              <input type="text" class="form-control" name="faduracionnoviazgo" value="<?php echo $faduracionnoviazgo ?>" disabled>
                                      ...
                                      <div class="col-sm-6">
                                        <div class="form-group">
                                          <div class="form-line">
                                              <input type="text" class="form-control" name="faembarazo" value="<?php echo $faembarazo ?>" disabled>
                                      ...
                                      <div class="col-sm-6">
                                        <div class="form-group">
                                          <div class="form-line">
                                              <input type="text" class="form-control" name="fanumhijos" value="<?php echo $fanumhijos ?>" disabled>
                                      ...
                                      <div class="col-sm-3">
                                        <div class="form-group">
                                          <div class="form-line">
                                              <input type="text" class="form-control" name="fadivorcio" value="<?php echo $fadivorcio?>" disabled>
                                      ...
                                      <div class="col-sm-3">
                                        <div class="form-group">
                                          <div class="form-line">
                                              <input type="text" class="form-control" name="fadivorciofecha" value="<?php echo $fadivorciofecha?>" disabled>
                                      ...
                                      <div class="col-sm-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                              <input type="text" class="form-control" name="fanomcanon1" value="<?php echo $facanon1?>" disabled>
                                      ...
                                      <div class="col-sm-4">
                                        <div class="form-group">
                                            <div class="form-line">
                                              <input type="text" class="form-control" name="fapartecanon1" value="<?php echo $fapartecanon1?>" disabled>
                                      ...
                                      <div class="col-sm-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                              <input type="text" class="form-control" name="fanomcanon2" value="<?php echo $fanomcanon2?>" disabled>
                                      ...
                                      <div class="col-sm-4">
                                        <div class="form-group">
                                            <div class="form-line">
                                              <input type="text" class="form-control" name="fapartecanon2" value="<?php echo $fapartecanon2?>" disabled>
                                              <label class="form-label">De parte del:</label>
                                            </div>
                                        </div>
                                      </div>
                                      <div class="col-sm-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                              <input type="text" class="form-control" name="fanomcanon3" value="<?php echo $fanomcanon3?>" disabled>
                                      ...
                                      <div class="col-sm-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                              <input type="text" class="form-control" name="fanomcanon4" value="<?php echo $fanomcanon4?>" disabled>
                                      ...
                                      <div class="col-sm-4">
                                        <div class="form-group">
                                            <div class="form-line">
                                              <input type="text" class="form-control" name="fapartecanon4" value="<?php echo $fapartecanon4?>" disabled>
                                              <label class="form-label">De parte del:</label>
                                            </div>
                                        </div>
                                      </div>
                                      <div class="col-sm-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                              <input type="text" class="form-control" name="fanomcanon5"  value="<?php echo $fanomcanon5?>" disabled>
                                      ...
                                      <div class="col-sm-4">
                                        <div class="form-group">
                                            <div class="form-line">
                                              <input type="text" class="form-control" name="fapartecanon5" value="<?php echo $fapartecanon5?>" disabled>
                                              <label class="form-label">De parte del:</label>
                                            </div>
                                        </div>
                                      </div>
